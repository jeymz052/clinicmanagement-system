...
export const DOCTORS: Doctor[] = [
  { id: "lina-fox", name: "Dr. Lina Fox", specialty: "Family Medicine" },
  { id: "omar-reed", name: "Dr. Omar Reed", specialty: "Internal Medicine" },
  { id: "amara-singh", name: "Dr. Amara Singh", specialty: "Dermatology" },
];

export const SLOT_TEMPLATES_BY_DOCTOR: Record<string, SlotTemplate[]> = {
  "lina-fox": [
    { start: "08:00", end: "09:00", mode: "Clinic" },
    { start: "09:00", end: "10:00", mode: "Both" },
    { start: "10:00", end: "11:00", mode: "Both" },
    { start: "11:00", end: "12:00", mode: "Online" },
    { start: "13:00", end: "14:00", mode: "Both" },
    { start: "14:00", end: "15:00", mode: "Clinic" },
  ],
  "omar-reed": [
    { start: "09:00", end: "10:00", mode: "Both" },
    { start: "10:00", end: "11:00", mode: "Clinic" },
    { start: "11:00", end: "12:00", mode: "Both" },
    { start: "13:00", end: "14:00", mode: "Online" },
    { start: "14:00", end: "15:00", mode: "Both" },
    { start: "15:00", end: "16:00", mode: "Both" },
  ],
  "amara-singh": [
    { start: "08:00", end: "09:00", mode: "Online" },
    { start: "09:00", end: "10:00", mode: "Both" },
    { start: "10:00", end: "11:00", mode: "Both" },
    { start: "11:00", end: "12:00", mode: "Clinic" },
    { start: "13:00", end: "14:00", mode: "Both" },
    { start: "14:00", end: "15:00", mode: "Both" },
  ],
};
...
export const INITIAL_APPOINTMENTS: AppointmentRecord[] = [
  {
    ...
    status: "Paid",
    queueNumber: 1,
    meetingLink: "https://meet.chiara.app/lina-fox-20260413-0900-1",
  },
  {
    id: "apt-002",
    ...
    type: "Online",
    reason: "Recurring migraine review",
    status: "Paid",
    queueNumber: 2,
    meetingLink: "https://meet.chiara.app/lina-fox-20260413-0900-2",
  },
  {
    id: "apt-003",
  ...
  },
  {
    ...
    status: "Paid",
    queueNumber: 1,
    meetingLink: "https://meet.chiara.app/omar-reed-20260414-1500-1",
  },
  {
    id: "apt-010",
    patientName: "Emma Baker",
...
export function createAppointmentRecord(
  ...
  return {
    ...
    status: input.type === "Clinic" ? "Confirmed" : "Pending Payment",
